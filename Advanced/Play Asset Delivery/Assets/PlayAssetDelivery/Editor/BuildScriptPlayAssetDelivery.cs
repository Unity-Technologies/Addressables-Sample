...
namespace AddressablesPlayAssetDelivery.Editor
{
    ...
    /// At build time this will be used by the <see cref="PlayAssetDeliveryPreBuildProcessor"/> to relocate bundles to their corresponding .androidpack paths.
    /// * Create a 'CustomAssetPacksData.json' file to store custom asset pack information to be used at runtime.
    ///
    /// We assign any content marked for "install-time" delivery to the generated asset packs. In most cases the asset pack containg streaming assets will use "install-time" delivery,
