...
## [0.7.0] - 2019-04-08
 ...
 - Player content is now built into target specific locations.  The addressables_content_state.bin as well as the content catalog and associated data now reside in platform relevant folders.
