...
public struct AsyncOperationHandle<TObject> : IEnumerator, IEquatable<AsyncOperationHandle<TObject>>
{
    ...
    /// </summary>
    public System.Threading.Tasks.Task<TObject> Task { get { return InternalOp.Task; } }

    /// <summary>
    /// Debug name of the operation.
    /// </summary>
    public string DebugName { get { return ((IAsyncOperation)InternalOp).DebugName; } }
    /// <summary>
    /// Check if the handle references an internal operation.
    /// </summary>
    /// <returns>True if valid.</returns>
    public bool IsValid() { return m_InternalOp != null && m_InternalOp.Version == m_Version; }
    /// <summary>
    /// Release the handle.  If the internal operation reference count reaches 0, the resource will be released.
    /// </summary>
    internal void Release() { InternalOp.DecrementReferenceCount(); m_InternalOp = null;}
    /// <summary>
    ...
    internal AsyncOperationHandle<TObject> Acquire() { InternalOp.IncrementReferenceCount(); return this; }

    /// <summary>
    /// The current reference count of the internal operation.
    /// </summary>
    internal int ReferenceCount { get { return InternalOp.ReferenceCount; } }
    /// <summary>
    /// The progress of the internal operation.
    /// </summary>
    public float PercentComplete { get { return InternalOp.PercentComplete; } }
    /// <summary>
    /// The status of the internal operation.
    /// </summary>
    public AsyncOperationStatus Status { get { return InternalOp.Status; } }
    /// <summary>
    ...
    /// </summary>
    public Exception OperationException { get { return InternalOp.OperationException; } }
    /// <summary>
    /// The result object of the operations.
    /// </summary>
    public TObject Result { get { return InternalOp.Result; } }
    /// <summary>
    /// True if the operation is complete.
    /// </summary>
    public bool IsDone { get { return !IsValid() || InternalOp.IsDone; } }
    ...
    object IEnumerator.Current { get { return Result; } }
...
public struct AsyncOperationHandle : IEnumerator
{
    ...
    /// Debug name of the operation.
    /// </summary>
    public string DebugName { get { return InternalOp.DebugName; } }
    ...
    public AsyncOperationHandle<T> Convert<T>() { return new AsyncOperationHandle<T>(InternalOp); }
    ...
    /// </summary>
    /// <returns>A new handle to the operation.  This handle must also be released.</returns>
    internal AsyncOperationHandle Acquire() { InternalOp.IncrementReferenceCount(); return this; }
    /// <summary>
    /// The current reference count of the internal operation.
    /// </summary>
    internal int ReferenceCount { get { return InternalOp.ReferenceCount; } }
    ...
    /// Return a Task object to wait on when using async await.
    /// </summary>
    public System.Threading.Tasks.Task<object> Task { get { return InternalOp.Task; } }
    ...
    /// The result object of the operations.
    /// </summary>
    public object Result { get { return InternalOp.GetResultAsObject(); } }
